...
#building =Building(0,550,random.randint(10,200),random.randint(10,700),RED)
building =Building(0,550,20,60,RED)
...
class Scroller(object):
    ...
    def __init__(self, width, max_height, base, color, speed):
        self.width = width
    ...
    def add_buildings(self):
        ...
        '''current_width = 0 
        while self.width < SCREEN_WIDTH:
            width = rand(1,(width-current_width))
            max_height = rand(10,self.maxh)
    ...
    def add_building(self, x_location):
        ...
        while current_width < self.width:
            ...
            #self.buildings.append(building) 
            building = Building(current_width, y_pointm, width_building, (y_point - 200), self.color)
            current_width += width_building

...
class Scroller(object):
    ...
    def add_buildings(self):
        ...
        scroller. - draw building, and to current width
        """
        self.width = 800 #width of screen
        self.current_width = 0 #total width of all rects
        width_building = random.randint(20,80)

        while self.width >= self.current_width:
            self.add_building(self.current_width)
            self.current_width += width_building

        if self.width <= self.current_width:
            self.current_width=0
            self.add_building(self.current_width)
    ...
    def add_building(self, x_location):
        ...
        self.x_location = self.current_width
        """
        ...
        y_point = random.randint(200,self.height)
        width_building = random.randint(20,80)
        b = Building(self.current_width, y_point, width_building, (500 - y_point), self.color)
    ...
    def move_buildings(self):
        ...
        for building in self.buildings:
            ...
            """if self.building[len(self.building-1)][1] < 800:
                y_point = random.randint(200,self.height)
                width_building = random.randint(20,80)
                b = Building(self.current_width, y_point, width_building, (500 - y_point), self.color)
                self.buildings.append(b)

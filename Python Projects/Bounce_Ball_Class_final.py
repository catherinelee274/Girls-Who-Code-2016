...
ball2 = BouncingBall(350, 250, 22, 28, 40)
ball3 = BouncingBall(350, 250, 12, 1, 22)
ball4 = BouncingBall(350, 250, 34, 20, 5)
ball5 = BouncingBall(350, 250, 1, 9, 11)
# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
    ...
    ball.flashBounce(screen, BLUE, 700, 500)
    ball2.flashBounce(screen, BLACK, 700, 500)
    ball3.flashBounce(screen, BLUE, 700, 500)
    ball4.flashBounce(screen, BLACK, 700, 500)
    ball5.flashBounce(screen, RED, 700, 500)

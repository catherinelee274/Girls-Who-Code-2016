...
while not done:
    ...
    pygame.draw.circle(screen, ball_color, [x_location2, y_location2], ball_size) #ball 2
    ...
    '''if x_location == x_location2 and y_location == y_location2:
        x_speed = x_speed * -1
        x_speed2 = x_speed2 * -1 #attempting to make the balls bounce off each other 
        y_speed = y_speed * -1
        y_speed2 = y_speed2 * -1'''
